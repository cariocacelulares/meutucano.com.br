  ...
  <Modal name="Logistic" icon="exchange" title="Logística reversa" :on-show="fetch" :on-confirm="save">
    <form>
      ...
      <div class="grid-2 hgap-20">
        <TInput label="Autorização da postagem" placeholder="Código da autorização dos correios" />
      ...
      <TTextarea label="Observações" placeholder="Insira observações gerais relacionadas à logística reversa" :block="true" />
    </form>
