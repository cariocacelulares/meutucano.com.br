<?php namespace Modules\Meta\Providers;
...
class MetaServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = base_path('resources/views/modules/meta');
    ...
    {
        $langPath = base_path('resources/lang/modules/meta');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'meta');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../', 'meta');
        }
    }
