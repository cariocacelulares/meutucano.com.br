...
$factory->define(\Modules\Rastreio\Models\Rastreio::class, function () use ($faker) {
  return [
...
$factory->define(\Modules\Rastreio\Models\Devolucao::class, function () use ($faker) {
  return [
...
$factory->define(\Modules\Rastreio\Models\Logistica::class, function () use ($faker) {
  return [
...
$factory->define(\Modules\Rastreio\Models\Pi::class, function () use ($faker) {
  return [
